...
int main()
{
    ...
    cout << "Enter the number of elements you desire to enter: ";
    cin >> n;
    Arr.enterElements(n);
    cout << "The array is: ";
    Arr.display();
    ...
    cout << "Enter a number for which the index is sought: ";
    cin >> n;
    if (Arr.isSorted())
        if (Arr.bSearch(n) != -1)
    ...
    cout << "Enter an index and replacement for replacing an element: ";
    cin >> in >> n;
    cout << Arr.set(n, in) << " was replaced with " << n << " at index " << in << "\n";
    cout << "The array is: ";
    Arr.display();

    cout << "Enter an index to get the element situated therein: ";
    cin >> in;
