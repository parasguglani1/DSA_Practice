    ...
    if (size >= 8 && size <= 15)
    {
        ...
        for (i = 0; i < size; i++)
        {
            ...
            if (UPPER)
                ...
                low++;
            else if (s[i] == '~' || s[i] == '!' || s[i] == '@' || s[i] == '#' || s[i] == '$' || s[i] == '%' || s[i] == '^' || s[i] == '&' || s[i] == '*' || s[i] == '(' || s[i] == ')' || s[i] == '-' || s[i] == '+' || s[i] == '{' || s[i] == '}' || s[i] == '[' || s[i] == ']' || s[i] == ';' || s[i] == ':' || s[i] == '|' || s[i] == '/' || s[i] == ',' || s[i] == '<' || s[i] == '>' || s[i] == '.' || s[i] == '?' || s[i] == '/' || s[i] == '=' || s[i] == '_')
                spChar++;
